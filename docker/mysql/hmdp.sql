...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `hmdp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
--
-- Table structure for table `tb_mq_transaction_log`
--

DROP TABLE IF EXISTS `tb_mq_transaction_log`;
...
--
-- Dumping events for database 'hmdp'
--
...
-- Dump completed on 2026-08-18 16:15:10
